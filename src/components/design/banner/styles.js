...
const { green, dark } = colors;
const { defaultSize, borderS, borderL } = sizes;

export const Banner = styled.div`
  position: relative;
  border-bottom: ${borderL} solid ${dark};
  ...
  a {
    position: relative;
    margin: 0 0 ${rem("1px", defaultSize)} ${rem("20px", defaultSize)};
    border-bottom: ${rem(borderS, defaultSize)};
    font-weight: ${bold};
    color: ${dark};
